...
var Logo$2 = function (_a) {
    ...
    var textColor = isDark ? "#FFFFFF" : "rgb(12, 14, 27)";
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default.createElement(PriceLink, { href: "https://beanswap.finance/swap?outputCurrency=0x91A46Fbf7D7a41f296457c937C782113078700b0", target: "_blank" },
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", backgroundAlt: "#FFFFFF", backgroundAlt2: "rgba(255, 255, 255, 0.7)", cardBorder: "#E7E3EB", contrast: "#191326", dropdown: "#F6F6F6", dropdownDeep: "#EEEEEE", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#d7caec", tertiary: "#EFF4F5", text: "#000000", textDisabled: "#BDC2C4", textSubtle: "#000000", disabled: "#E9EAEB", gradients: {
...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#000000", background: "#000000", backgroundDisabled: "#3c3742", backgroundAlt: "#000000", backgroundAlt2: "rgba(39, 38, 44, 0.7)", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#372F47", inputSecondary: "#262130", primaryDark: "#000000", tertiary: "#353547", text: "#F4EEFF", textDisabled: "#666171", textSubtle: "#B8ADD2", disabled: "#524B63", gradients: {
        bubblegum: "linear-gradient(139.73deg, #000000 0%, #000000 100%)",
        ...
        gold: "linear-gradient(180deg, #000000 0%, #000000 100%)",
    } });
...
var socials = [
    {
        label: "Twitter",
        icon: "Twitter",
        href: "https://twitter.com/BeanEcoChain",
    },
    {
        label: "Twitter",
        icon: "Twitter",
        href: "https://twitter.com/beanfliptoken",
    },
    {
        label: "Telegram",
        icon: "Telegram",
        href: "https://t.me/BeanEcosystem",
        
    },
    {
        label: "Medium",
        icon: "Medium",
        href: "https://link.medium.com/6WYyR7KxXvb",
        ...
        React__default.createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default.createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default.createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default.createElement(Button, { as: "a", href: "https://beanswap.finance/swap?outputCurrency=0x91A46Fbf7D7a41f296457c937C782113078700b0", target: "_blank", scale: "sm", endIcon: React__default.createElement(Icon$27, { color: lightColors.backgroundAlt }) }, buyCakeLabel))))));
};
...
var links = [
    {
        ...
        items: [
            {
                label: "Exchange",
                href: "https://exchange.beanswap.finance",
            },
            {
                label: "Liquidity",
                href: "https://exchange.beanswap.finance/#/pool",
            },
            {
                label: "Charts",
                href: "https://exchange.beanswap.finance/#/charts",
                iconName: "Chart",
                isMobileOnly: true,
            },
        ],
    ...
    return (React__default.createElement(ModalContainer, { minWidth: "320px" },
        ...
        React__default.createElement(ModalBody, { width: ["320px", null, "340px"] },
            ...
            React__default.createElement(Box, { p: "24px" },
                ...
                React__default.createElement(Button, __assign({ as: "a", href: "https://cryptopreneur.gitbook.io/cryptopreneur/", variant: "subtle", width: "100%" }, getExternalLinkProps()), t("Learn How to Connect"))))));
};
