...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and BEANS pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and BEANS pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from BEANS pool', data)
  }
