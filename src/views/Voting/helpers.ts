...
import { ADMINS, PANBEANS_SPACE, SNAPSHOT_VERSION } from './config'
...
export const generateMetaData = () => {
  return {
    plugins: {},
    network: 535037,
    strategies: [{ name: 'BEANS', params: { symbol: 'BEANS', address: tokens.cake.address, decimals: 18 } }],
  }
}
