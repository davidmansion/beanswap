  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active BEANS Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold BEANS'),
      bodyText: [t('Each NFT costs BEANS to mint. Remember you also need BESC to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://beanswap.finance/swap?outputCurrency=0x91A46Fbf7D7a41f296457c937C782113078700b0"
            target="_blank"
            width="100%"
          >
            {t('Buy BEANS')}
