        ...
        <Flex flexDirection="column">
          <Box px="16px">
            ...
            <Flex mb="8px" justifyContent="space-between">
              ...
              <Text font-size="14px">{formatBigNumber(pricePerTicket, 0)} BEANS</Text>
            </Flex>
            <Flex mb="8px" justifyContent="space-between">
              <Text font-size="14px" color="textSubtle">
                {t('Your BEANS Balance')}
              </Text>
              <Text font-size="14px" color={isCakeBalanceInsufficient ? 'failure' : 'text'}>
                {formatBigNumber(cakeBalance, 3)} BEANS
              </Text>
            </Flex>
            <Flex
              mb="8px"
            ...
            <Flex mb="25px" justifyContent="space-between">
              ...
              <Text font-size="14px" bold>
                {formatBigNumber(totalCost, 0)} BEANS
              </Text>
            </Flex>
          </Box>
          <Flex
