...
import { BESCAmountLabel } from '../components/CollectibleCard/styles'
...
const Collections = () => {
  ...
  const orderedCollections = orderBy(
    collections,
    (collection) => (collection.totalVolumeBESC ? parseFloat(collection.totalVolumeBESC) : 0),
    'desc',
  )
          ...
          return (
            ...
            >
              <Flex alignItems="center">
                ...
                <BESCAmountLabel amount={collection.totalVolumeBESC ? parseFloat(collection.totalVolumeBESC) : 0} />
              </Flex>
            </HotCollectionCard>
          )
        })}
