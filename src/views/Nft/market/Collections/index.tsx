          ...
          <Table>
            <thead>
              <tr>
                ...
                <Th textAlign="left" style={{ cursor: 'pointer' }} onClick={() => handleSort(SORT_FIELD.volumeBESC)}>
                  {t('Volume')}
                  {arrow(SORT_FIELD.volumeBESC)}
                </Th>
                {!isMobile && (
                  <>
            ...
            <tbody>
              {sortedCollections.map((collection) => {
                const volume = collection.totalVolumeBESC
                  ? parseFloat(collection.totalVolumeBESC).toLocaleString(undefined, {
