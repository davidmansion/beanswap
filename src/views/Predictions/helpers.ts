...
const MIN_PRICE_BESC_DISPLAYED = BigNumber.from('1000000000000000')
...
export const formatBnbv2 = (bnb: BigNumber) => {
  return formatPriceDifference({ price: bnb, minPriceDisplayed: MIN_PRICE_BESC_DISPLAYED, unitPrefix: '', decimals: 18 })
}
