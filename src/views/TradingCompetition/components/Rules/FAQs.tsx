        ...
        <StyledCardbody>
          <FoldableText title={t('Eligible trading pairs')} mt="24px">
            <Text fontSize="14px" color="textSubtle">
              {t(
                'Only trades on BESC/BUSD, BEANS/BESC, ETH/BESC and BTCB/BESC pairs will be included in volume calculations.',
              )}
            </Text>
          </FoldableText>
          ...
          <FoldableText title={t('Prize distribution')} mt="24px">
            <Text fontSize="14px" color="textSubtle">
              -{' '}
              {t(
                'Prizes to be distributed in BEANS and shared by all members of each respective tier as per the Prizes section above.',
              )}
            </Text>
            <Text fontSize="14px" color="textSubtle">
              -{' '}
              {t(
                'BEANS prizes will be distributed as per the BEANS/BUSD price on the day of distribution. Every eligible participant will win prizes at the end of the competition.',
              )}
            </Text>
            <Text fontSize="14px" color="textSubtle">
          ...
          <FoldableText title={t('Fine print')} mt="24px">
            <Text fontSize="14px" color="textSubtle">
              -{' '}
              {t(
                'In the event of a disagreement concerning the final winning team or rank, BEANS will have the final say.',
              )}
            </Text>
            <Text fontSize="14px" color="textSubtle">
              -{' '}
              {t(
                'BEANS can and will disqualify any team or specific members that are proven to have taken malicious action or attempt to “cheat” in any way.',
              )}
            </Text>
          </FoldableText>
