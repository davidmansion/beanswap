...
const bnbToWBESCSymbol = (sym: string) => (sym === 'BESC' ? 'WBESC' : sym)
...
const TradingViewChart = ({
  ...
  const symbol = useMemo(() => {
    ...
    const prefix = 'BEANS:'
    const input = bnbToWBESCSymbol(inputCurrency.symbol)
    const output = bnbToWBESCSymbol(outputCurrency.symbol)
