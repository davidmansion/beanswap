...
import wrappedBESC from 'config/abi/wrappedBnb.json'
...
export const getwrappedBESCContract = (address: string, signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(wrappedBESC, address, signer)
}
